...
public class ServiceTemplateType extends ApiPropertyBase {
	...
	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling, List<ServiceTemplateInterfaceType> interface_type, String flavor,
			boolean ordered_interfaces, String service_virtualization_type, boolean availability_zone_enable,
			String vrouter_instance_type, String instance_data) {
	...
	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling) {
		this(version, service_mode, service_type, image_name, service_scaling, null, null, false, null, false, null,
				null);
	}

	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling, List<ServiceTemplateInterfaceType> interface_type) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, null, false, null, false,
				null, null);
	}

	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling, List<ServiceTemplateInterfaceType> interface_type, String flavor) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, flavor, false, null,
				false, null, null);
	}
	...
	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling, List<ServiceTemplateInterfaceType> interface_type, String flavor,
			boolean ordered_interfaces) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, flavor,
				ordered_interfaces, null, false, null, null);
	}

	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			boolean service_scaling, List<ServiceTemplateInterfaceType> interface_type, String flavor,
			boolean ordered_interfaces, String service_virtualization_type) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, flavor,
				ordered_interfaces, service_virtualization_type, false, null, null);
	}
	...
	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			...
			boolean ordered_interfaces, String service_virtualization_type, boolean availability_zone_enable) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, flavor,
				ordered_interfaces, service_virtualization_type, availability_zone_enable, null, null);
	}
	...
	public ServiceTemplateType(Integer version, String service_mode, String service_type, String image_name,
			...
			String vrouter_instance_type) {
		this(version, service_mode, service_type, image_name, service_scaling, interface_type, flavor,
				ordered_interfaces, service_virtualization_type, availability_zone_enable, vrouter_instance_type, null);
	}
